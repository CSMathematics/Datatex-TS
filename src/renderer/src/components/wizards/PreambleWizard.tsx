...
import { Modal, Form, Input, Select, InputNumber, Checkbox, Divider, Switch } from 'antd';
        ...
        >
            ...
            >
                ...
                <div style={{ display: 'flex', gap: 16 }}>
                    <Form.Item name="author" label="Author" style={{ flex: 1 }}><Input /></Form.Item>
                    <Form.Item name="date" label="Include Date" valuePropName="checked"><Switch /></Form.Item>
                </div>
                <Form.Item name="title" label="Document Title"><Input /></Form.Item>
            </Form>
        </Modal>
    );
};

export default PreambleWizard;
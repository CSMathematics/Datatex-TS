...
import { Form, InputNumber, Switch, Button, Card } from 'antd'

interface TableWizardViewProps {
  onInsert: (code: string) => void
}

const TableWizardView: React.FC<TableWizardViewProps> = ({ onInsert }) => {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 800, margin: '0 auto', color: '#fff' }}>
      <Card title="Table Wizard" bordered={false} style={{ background: '#252526' }}>
        <Form
          form={form}
          layout="vertical"
...
export default TableWizardView

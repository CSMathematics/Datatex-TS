        ...
        >
            ...
            >
                <div style={{ display: 'flex', gap: 16 }}>
                    <Form.Item name="rows" label="Rows" rules={[{ required: true }]}><InputNumber min={1} /></Form.Item>
                    <Form.Item name="cols" label="Columns" rules={[{ required: true }]}><InputNumber min={1} /></Form.Item>
                </div>
                <Form.Item name="border" valuePropName="checked" label="Add Borders"><Switch /></Form.Item>
                <Form.Item name="center" valuePropName="checked" label="Center Table"><Switch /></Form.Item>
            </Form>
        </Modal>
    );
};
